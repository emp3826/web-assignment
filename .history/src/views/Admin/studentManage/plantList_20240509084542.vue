<template>
  <div>
    <el-table border stripe :data="tableData" v-loading="loading">
      ...
      <el-table-column prop="caregory_id" label="分类">
        <template slot-scope="scope">
         <div v-if="scope.row.caregory_id === 0">陆地植物</div>
         <div v-if="scope.row.caregory_id === 1">水生植物</div>
         <div v-if="scope.row.caregory_id === 2">藻类植物</div>
        </template>
      </el-table-column>
